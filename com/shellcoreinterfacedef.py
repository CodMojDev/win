...
LPCMINVOKECOMMANDINFO = PCCMINVOKECOMMANDINFO = PTR(CMINVOKECOMMANDINFO)
...
LPCMINVOKECOMMANDINFOEX = PCCMINVOKECOMMANDINFO = PTR(CMINVOKECOMMANDINFOEX)
...
class IShellFolder(IUnknown):
    ...
    @virtual_table.com_function(PTR(ITEMIDLIST_RELATIVE), LPBINDCTX, LPIID, PVOID, intermediate_method = True, marshal_scheme=[(2, RetVal_Dereference)])
    ...
    @virtual_table.com_function(HWND, LPIID, PVOID, intermediate_method = True, marshal_scheme=[(1, RetVal_Dereference)])
    def CreateViewObject(self, hwndOwner: int, iid: IID, ppv: IPointer[PVOID], **kwargs) -> int:
        return self.virt_delegate(hwndOwner, iid.ref() if iid else NULL, iid, ppv)
    ...
    @virtual_table.com_function(HWND, UINT, PTR(PITEMID_CHILD), LPIID, PUINT, PVOID, intermediate_method = True, marshal_scheme=[(3, RetVal_Dereference)])
...
class IShellView(IOleWindow):
    ...
    @virtual_table.com_function(DWORD, LPFNADDPROPSHEETPAGE, LPARAM)
...
if _version >= WIN32_WINNT_VISTA:
    ...
    class ICommDlgBrowser2(ICommDlgBrowser):
        ...
        _iid_ = IID("{10339516-2894-11D2-9039-00C04F8EEB3E}")
...
class IShellPropSheetExt(IUnknown):
    ...
    @virtual_table.com_function(LPFNADDPROPSHEETPAGE, LPARAM)
    def AddPages(self, pfnAddPage: FARPROC, lParam: int) -> int: ...

    @virtual_table.com_function(EXPPS, LPFNADDPROPSHEETPAGE, LPARAM)
...
if WIN32_IE >= WIN32_IE_IE70:
    ...
    class IObjectProvider(IUnknown):
        virtual_table = COMVirtualTable.from_ancestor(IUnknown)
        _iid_ = IID("{A6087428-3BE3-4D73-B308-7C04A540BF1A}")
