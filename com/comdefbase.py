...
E_NOTIMPL = HRESULT(0x80004001).value
E_NOINTERFACE = HRESULT(0x80004002).value
E_POINTER = HRESULT(0x80004003).value
E_FAIL = HRESULT(0x80004005).value
E_INVALIDARG = HRESULT(0x80070057).value
E_OUTOFMEMORY = HRESULT(0x8007000E).value
E_ABORT = HRESULT(0x80004004).value
E_ACCESSDENIED = HRESULT(0x80070005).value
INTSAFE_E_ARITHMETIC_OVERFLOW = HRESULT(0x80070216).value

CLASS_E_NOAGGREGATION = 0x80040110
CLASS_E_CLASSNOTAVAILABLE = 0x80040111

CO_E_CLASSSTRING = HRESULT(0x800401F3).value
...
TYPE_E_ELEMENTNOTFOUND = HRESULT(0x8002802B).value

TYPE_E_REGISTRYACCESS = HRESULT(0x8002801C).value
TYPE_E_CANTLOADLIBRARY = HRESULT(0x80029C4A).value
...
DISP_E_PARAMNOTOPTIONAL = HRESULT(0x8002000F).value
DISP_E_BADPARAMCOUNT = HRESULT(0x8002000E).value
DISP_E_ARRAYISLOCKED = HRESULT(0x8002000D).value
DISP_E_UNKNOWNLCID = HRESULT(0x8002000C).value
DISP_E_BADINDEX = HRESULT(0x8002000B).value
DISP_E_OVERFLOW = HRESULT(0x8002000A).value
DISP_E_EXCEPTION = HRESULT(0x80020009).value
DISP_E_BADVARTYPE = HRESULT(0x80020008).value
DISP_E_NONAMEDARGS = HRESULT(0x80020007).value
DISP_E_UNKNOWNNAME = HRESULT(0x80020006).value
DISP_E_TYPEMISMATCH = HRESULT(0x800020005).value
DISP_E_PARAMNOTFOUND = HRESULT(0x80020004).value
DISP_E_MEMBERNOTFOUND = HRESULT(0x80020003).value
DISP_E_UNKNOWNINTERFACE = HRESULT(0x80020001).value

RPC_E_CHANGED_MODE = HRESULT(0x80010106).value
RPC_E_SERVERFAULT = HRESULT(0x80010105).value
