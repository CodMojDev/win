...
if cpreproc.pragma_once("_INC_SDKDDKVER"):
	#
    ...
    WIN32_WINNT_WINTHRESHOLD = 0x0A00 # ABRACADABRA_THRESHOLD
    WIN32_WINNT_WIN10 = 0x0A00 # ABRACADABRA_THRESHOLD
	#
    ...
    WIN32_IE_IE110 = 0x0A00 # ABRACADABRA_THRESHOLD
	#
    ...
    WIN32_IE_WINTHRESHOLD = WIN32_IE_IE110 # ABRACADABRA_THRESHOLD
    WIN32_IE_WIN10 = WIN32_IE_IE110 # ABRACADABRA_THRESHOLD
	#
	...
	#
    OSVER = lambda Version: ((Version) & OSVERSION_MASK)
    SPVER = lambda Version: (((Version) & SPVERSION_MASK) >> 8)
    SUBVER = lambda Version: (((Version) & SUBVERSION_MASK))
    ...
    elif _version <= WIN32_WINNT_VISTA:
        WIN32_IE = WIN32_IE_LONGHORN
    elif _version <= WIN32_WINNT_WIN7:
        WIN32_IE = WIN32_IE_WIN7
    elif _version <= WIN32_WINNT_WIN8:
        WIN32_IE = WIN32_IE_WIN8
    else:
        WIN32_IE = WIN32_WINNT_WIN10