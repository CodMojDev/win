...
class IMoniker(IPersistStream):
    ...
    def ParseDisplayName(self, pbc: IPointer[IBindCtx], pmkToLeft: IPointer['IMoniker'], pszDisplayName: LPOLESTR, pchEaten: IPointer[ULONG], ppmkOut: IDoublePtr['IMoniker']) -> int: ...
...
class IROTData(IUnknown):
    ...
    def GetComparisonData(self, pbData: PBYTE, cbMax: int, pcbData: IPointer[ULONG]) -> int: ...
...
class IEnumSTATSTG(IUnknown):
    ...
    def Next(self, celt: int, rgelt: IPointer[STATSTG], pceltFetched: IPointer[ULONG]) -> int: ...
...
class ILockBytes(IUnknown):
    ...
    def ReadAt(self, ulOffset: ULARGE_INTEGER, pv: PVOID, cb: int, pcbRead: IPointer[ULONG]) -> int: ...

    @virtual_table.com_function(ULARGE_INTEGER, LPCVOID, ULONG, PULONG)
    def WriteAt(self, ulOffset: ULARGE_INTEGER, pv: LPCVOID, cb: int, pcbWritten: IPointer[ULONG]) -> int: ...
...
class IEnumFORMATETC(IUnknown):
    ...
    def Next(self, celt: int, rgelt: IPointer[FORMATETC], pceltFetched: IPointer[ULONG]) -> int: ...
...
class IEnumSTATDATA(IUnknown):
    ...
    def Next(self, celt: int, rgelt: IPointer[STATDATA], pceltFetched: IPointer[ULONG]) -> int: ...
...
class IFillLockBytes(IUnknown):
    ...
    def FillAppend(self, pv: LPCVOID, cb: int, pcbWritten: IPointer[ULONG]) -> int: ...

    @virtual_table.com_function(ULARGE_INTEGER, LPCVOID, ULONG, PULONG)
    def FillAt(self, ulOffset: ULARGE_INTEGER, pv: LPCVOID, cb: int, pcbWritten: IPointer[ULONG]) -> int: ...
...
class IThumbnailExtractor(IUnknown):
    ...
    def ExtractThumbnail(self, pStg: IPointer[IStorage], ulLength: int, ulHeight: int, pulOutputLength: IPointer[ULONG], pulOutputHeight: IPointer[ULONG], phOutputBitmap: IPointer[HBITMAP]) -> int: ...
