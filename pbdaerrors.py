...
MAKE_BDA_S_ITF_HRESULT(x)  = MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_NULL, (x))
MAKE_BDA_E_ITF_HRESULT(x)  = ( (MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, (x))) | 0x40000000 )    # setting bit 30 to 1
