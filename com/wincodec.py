...
class IWICBitmapFrameEncode(IUnknown):
    ...
    def WritePixels(self, lineCount: int, cbStride: int, cbBufferSize: int, pbPixels: PBYTE) -> int: ...

    @virtual_table.com_function(IWICBitmapSource.PTR(), WICRect.PTR())
    def WriteSource(self, pIBitmapSource: IPointer[IWICBitmapSource], prc: IPointer[WICRect]) -> int: ...
...
class IWICImagingFactory(IUnknown):
    ...
    @virtual_table.com_function(HICON, PVOID)
