...
class IProvideMultipleClassInfo(IProvideClassInfo2):
	...
	def GetMultiTypeInfoCount(self, pcti: IPointer[ULONG]) -> int: ...

	@virtual_table.com_function(ULONG, DWORD, DOUBLE_PTR(ITypeInfo), PDWORD, PULONG, LPIID, LPIID)
	def GetInfoOfIndex(self, iti: int, dwFlags: int, pptiCoClass: IDoublePtr[ITypeInfo], pdwTIFlags: PDWORD, pcdispidReserved: IPointer[ULONG], piidPrimary: IPointer[IID], piidSource: IPointer[IID]) -> int: ...
...
class IPersistMemory(IPersist):
	...
	@virtual_table.com_function(PULONG)
	def GetSizeMax(self, pCbSize: IPointer[ULONG]) -> int: ...
...
class IPropertyBag2(IUnknown):
	...
	@virtual_table.com_function(PULONG)
	def CountProperties(self, pcProperties: IPointer[ULONG]) -> int: ...

	@virtual_table.com_function(ULONG, ULONG, PTR(PROPBAG2), PULONG)
	def GetPropertyInfo(self, iProperty: int, cProperties: int, pPropBag: IPointer[PROPBAG2], pcProperties: IPointer[ULONG]) -> int: ...
