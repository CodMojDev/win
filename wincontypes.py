...
if cpreproc.pragma_once("_WINCONTYPES_"):
    ...
    class KEY_EVENT_RECORD(CStructure):
        class _uChar(Union):
            _fields_ = [
                ("UnicodeChar", WCHAR),
                ("AsciiChar", CHAR)
    ...
    class MOUSE_EVENT_RECORD(CStructure):
        _fields_ = [
    ...
    class WINDOW_BUFFER_SIZE_RECORD(CStructure):
        _fields_ = [
            ("dwSize", COORD)
        ]
    ...
    class MENU_EVENT_RECORD(CStructure):
        _fields_ = [
            ("dwCommandId", UINT)
        ]
    ...
    class FOCUS_EVENT_RECORD(CStructure):
        _fields_ = [
            ("bSetFocus", BOOL)
        ]
