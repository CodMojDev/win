...
def VarUI4FromUI1(bIn: int, pulOut: IPointer[ULONG]) -> int: ...

@oleaut_foreign(SHORT, PULONG)
def VarUI4FromI2(uiIn: int, pulOut: IPointer[ULONG]) -> int: ...

@oleaut_foreign(LONG, PULONG)
def VarUI4FromI4(lIn: int, pulOut: IPointer[ULONG]) -> int: ...

@oleaut_foreign(LONGLONG, PULONG)
def VarUI4FromI8(i64In: int, plOut: PLONG) -> int: ...

@oleaut_foreign(FLOAT, PULONG)
def VarUI4FromR4(fltIn: float, pulOut: IPointer[ULONG]) -> int: ...

@oleaut_foreign(DOUBLE, PULONG)
def VarUI4FromR8(dblIn: float, pulOut: IPointer[ULONG]) -> int: ...

@oleaut_foreign(DOUBLE, PULONG)
def VarUI4FromDate(dateIn: float, pulOut: IPointer[ULONG]) -> int: ...

@oleaut_foreign(CY, PULONG)
def VarUI4FromCy(cyIn: CY, pulOut: IPointer[ULONG]) -> int: ...

@oleaut_foreign(LPOLESTR, ULONG, ULONG, PULONG)
def VarUI4FromStr(strIn: LPOLESTR, lcid: int, dwFlags: int, pulOut: IPointer[ULONG]) -> int: ...

@oleaut_foreign(LPDISPATCH, ULONG, PULONG)
def VarUI4FromDisp(pdispIn: IPointer[IDispatch], lcid: int, pulOut: IPointer[ULONG]) -> int: ...

@oleaut_foreign(SHORT, PULONG)
def VarUI4FromBool(boolIn: int, pulOut: IPointer[ULONG]) -> int: ...

@oleaut_foreign(c_byte, PULONG)
def VarUI4FromI1(cIn: int, pulOut: IPointer[ULONG]) -> int: ...

@oleaut_foreign(WORD, PULONG)
def VarUI4FromUI2(uiIn: int, pulOut: IPointer[ULONG]) -> int: ...

@oleaut_foreign(ULONGLONG, PULONG)
def VarUI4FromUI8(ui64In: int, plOut: PLONG) -> int: ...

@oleaut_foreign(LPDECIMAL, PULONG)
def VarUI4FromDec(pdecIn: IPointer[DEC], pulOut: IPointer[ULONG]) -> int: ...
...
def VarUI4FromUI4(in_: int, pOut: IPointer[ULONG]):
    pOut.contents = in_
